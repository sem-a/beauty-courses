      ...
      <div className="wrapper">
        ...
        <div className="teacher__info">
          <p>
            ...
            свои знания начинающим мастерам, помогает адаптироваться и совершенствовать свои знания.
            Она прошла путь от мастера, который ничего не умел до профессионала, к которому
            выстраивается очередь из клиентов. Работа мастером помогает ей всегда быть в тренде и
            чувствовать новые веяния в сфере красоты
          </p>
        </div>
      </div>
    </div>
